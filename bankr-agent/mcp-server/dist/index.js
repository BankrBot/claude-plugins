        ...
        tools: [
            {
                ...
                description: "Submit a prompt to the Bankr API for crypto trading, market analysis, or Polymarket predictions. Returns a job ID that can be used to check status.",
                inputSchema: {
                    type: "object",
                    properties: {
                        prompt: {
                            type: "string",
                            description: "The prompt to send to Bankr (e.g., 'Buy $50 of ETH on Base', 'What is the price of Bitcoin?', 'Bet $5 on the Eagles to win')",
                        },
                    },
                    required: ["prompt"],
                },
            },
            {
                ...
                description: "Get the status of a Bankr job. Use this to poll for results after submitting a prompt. Status can be: pending, processing, completed, failed, or cancelled.",
                inputSchema: {
                    type: "object",
                    properties: {
                        job_id: {
            ...
            },
            {
                ...
                description: "Cancel a running Bankr job. Use this if the user wants to stop a job that is still processing.",
                inputSchema: {
                    type: "object",
                    properties: {
                        job_id: {
